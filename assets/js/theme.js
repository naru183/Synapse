...
//Typing effect code starts here

const textArray = ["Fair and lovely.", "Fast and secure.", "Safe and smooth.", "Fair and handsome.", "Fast and furious.", "Sound and vibrant.", "Easy and fun.", "Promising."];
let i = 0;
let j = 0;
let currentText = "";
...
function type() {
    ...
    currentText = isDeleting ? textArray[i].substring(0, j--) : textArray[i].substring(0, j++);
